...
public class SendMail {
    ...
    public static String sendEmailAccount = "2046905772@qq.com";
    // 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
    public static String sendEmailPassword = "xvszfpaxlpqbeecg";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
        ...
        // 设置发件人姓名和编码格式
        message.setFrom(new InternetAddress(sendMail, "电子病历系统", "UTF-8"));
        ...
        // 设置邮件正文
        message.setContent("您的验证码是"+mailContent+"，请在验证界面输入此验证码，" +
                "如果遇到问题请联系电子病历管理系统客服：0831-3378956", "text/html;charset=UTF-8");
